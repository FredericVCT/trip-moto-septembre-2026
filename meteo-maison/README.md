...
2. attend le commit « Météo maison : données du ... » qui met à jour `raw.json` (10 modèles déterministes + ensembles ECMWF IFS, ECMWF AIFS, ICON, GFS, avec le CAPE pour le risque d'orage) ;
